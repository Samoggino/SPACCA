...
public class Carta {
     ...
     * // per ora una matta vale come una carta normale, ma potrebbe essere
     * // modificato
     * 
     ...
     * }
     * 
     * public Carta(String seme, String nome) throws IllegalArgumentException {
     * this.seme = Seme.caseInsensitiveValueOf(seme);
     * this.nome = Nome.caseInsensitiveValueOf(nome);
